      ...
      <div className="mt-10 grid gap-6 lg:grid-cols-2">
        {testimonials.map((item, index) => (
          <Reveal key={item.name} delay={index * 0.1}>
            <div className="h-full rounded-[1.5rem] border border-red-200 bg-gradient-to-br from-white via-yellow-50 to-green-50 p-7 shadow-sm dark:border-slate-700 dark:bg-gradient-to-br dark:from-slate-900 dark:via-slate-900 dark:to-emerald-950">
