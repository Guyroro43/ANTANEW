    ...
    <section id="modules" className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div className="max-w-2xl">
          <p className="text-sm font-semibold uppercase tracking-[0.3em] text-amber-600">Modules</p>
          <h2 className="mt-3 text-3xl font-black text-slate-900 sm:text-4xl">
            Des parcours qui parlent à votre réalité.
          </h2>
        </div>
        <Link href="/modules" className="font-semibold text-amber-700 transition hover:text-amber-800">
          Voir tous les modules →
        </Link>
      </div>
      <div className="mt-10 grid gap-6 md:grid-cols-2">
        {modules.map((module) => (
          <div key={module.title} className="overflow-hidden rounded-[1.75rem] border border-slate-200 bg-white shadow-sm">
            ...
            <div className="p-6">
              ...
              <Link href="/modules" className="mt-5 inline-flex font-semibold text-amber-700 transition hover:text-amber-800">
                Explorer ce module →
              </Link>
            </div>
          </div>
